...
const createFileName = 'seed-data.sql';
const insertFileName = 'seed-data.sql';
...
module.exports.createTables = async function (){
  ...
  try {
    const createSqlPath = path.resolve(__dirname, '../sql-practice', createFileName);
...
module.exports.insertData = async function(client, otherError) {
  try {
    const insertSqlPath = path.resolve(__dirname, '../sql-practice', insertFileName);
