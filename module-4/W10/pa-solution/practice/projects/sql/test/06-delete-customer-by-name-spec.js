...
describe('Delete data', () => {
  ...
  describe('Find all customers', () => {
    it('returns the first name and last name of all the customers, ordered by last name then first name', async () => {
  ...
  describe('Find all tools purchased', () => {
    it('returns the tool name and quantity of all purchases, ordered by tool then quantity purchased (least to greatest)', async () => {
      if (stopTestOnError(client, createError, otherError)) return;
