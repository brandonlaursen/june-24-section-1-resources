...
describe('Query #1', () => {
  ...
  it('returns tool name, price, and quantity in each purchase for tools that have names starting with \'Pipe\', ordered by tool name then by the quantity purchased (least to greatest)', async () => {
