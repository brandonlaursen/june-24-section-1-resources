...
class HashTable { // get O(1), set O(1), deleteKey O(1)
  ...
  resize() {
    ...
    //! want to double capacity before inserting to ensure buckets are the same when copying values over
    ...
    for (let i = 0; i < oldData.length; i++) {
      ...
      // need to reinsert because when resizing the hash mod function index changes with the new capacity
      while (currentPair) {
